...
interface EventCreatedPopupProps {
  isOpen: boolean;
  onClose: () => void;
  onNavigate: (page: string) => void;
}

export function EventCreatedPopup({ isOpen, onClose, onNavigate }: EventCreatedPopupProps) {
  useEffect(() => {
    if (isOpen) {
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 mx-6 w-[300px] animate-slide-down pointer-events-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-[15px] font-semibold text-gray-900">Event Created!</h3>
